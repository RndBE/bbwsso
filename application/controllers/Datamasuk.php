  ...
  "content": "' . $message . '"
	...
	public function add_awlr()
	{
		...
		*/
		...
		########## KIRIM KE HIDROLOGI BBWSSO ##########
		$postDataBbws = http_build_query($databbws);
		$optionsBbws = array(
			'http' => array(
				'method'  => 'POST',
				'header'  => 'Content-type: application/x-www-form-urlencoded',
				'content' => $postDataBbws,
				'timeout' => 10
			)
		);
		$contextBbws = stream_context_create($optionsBbws);
		@file_get_contents('http://hidrologi.bbwsserayuopak.id/api/put?key=BBWSSOjogja@p!', false, $contextBbws);
		################## MQTT ############
		/*
	...
	*/
	...
	public function add_arr19_2()
	{
		...
		//echo $jwt;
		$idalat;
		if ($this->input->post('id_alat') == '10000')
			$idalat = "10248";
		else
			$idalat = $this->input->post('id_alat');
		if ($idalat == '10248') {
