			...
			<div class="col-12 col-md">
				...
				<div class="row g-2 align-items-center justify-content-end">
					...
					<div class="col-8 col-md-auto d-flex">
						<?php if($this->session->userdata('idlogger') == '10247'){ ?>
						<button data-bs-toggle="modal" data-bs-target="#skema_perangkat" class="btn btn-primary me-2">
						...
						<?php
						// Rekonsiliasi data logger — daftar pos ada di Awlr::$rekon_logger
						if (in_array((string) $this->session->userdata('idlogger'), array('10051'), true)) { ?>
							<a class="btn me-2 text-nowrap" href="<?= base_url() ?>awlr/rekonsiliasi">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0"> 
									<form action="<?= base_url() ?>awlr/set_pos" method="post" id="form-pos">

										<select type="text" name="pilihpos" class="form-select" placeholder="Pilih Pos AWLR" onchange="validate_form()" id="select-pos" value=" ">
										...
										<div>
											<table class="table table-sm table-borderless">
												<tbody>
													...
													<tr> <td  class="fw-bold">Nomor Seluler</td><td class="text-end"><?php  echo $tinfo->nosell ?></td></tr>
											...
											<?php if($this->session->userdata('idlogger') == '10247') { ?>
												<h3 class="text-center mb-1">Titik BM Pos Sungai Bogowonto</h3>
											<img src="https://bbwsso.monitoring4system.com/image/SB.jpeg" class="img-fluid mb-2 rounded"/>
											<h3 class="text-center mt-3 mb-1">Titik BM Pos Carik Barat</h3>
											<img src="https://bbwsso.monitoring4system.com/image/CB.jpeg" class="img-fluid mb-2 rounded"/>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Skema Perangkat</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body p-3 text-center d-flex justify-content-center">
		  <img src="<?= base_url() ?>image/awlr_bogowonto.png" class="img-fluid w-100" />
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Riwayat Operasional dan Perawatan</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
				...
				<div class="accordion" id="accordionExample">
					...
					<div class="accordion-item">
						<h2 class="accordion-header py-0">
							<button class="accordion-button py-2 border-bottom" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?= $k ?>" aria-expanded="false" aria-controls="collapse<?= $k ?>">
								<?= $dp['tanggal'] ?>
							</button>
						</h2>
