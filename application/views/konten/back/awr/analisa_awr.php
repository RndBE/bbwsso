					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0"> 
									<form action="<?= base_url() ?>awr/set_pos" method="post" id="form-pos">

									<select type="text" name="pilihpos" class="form-select" placeholder="Pilih Pos AWR" onchange="validate_form()" id="select-pos" value=" ">
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									...
									<?php  
	echo form_open('awr/set_parameter');?>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<?php echo form_open('awr/sesi_data');?>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('awr/setbulan') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="input-icon">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('awr/settahun') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="input-icon">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('awr/setrange') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="row">
												<div class="col-12 col-md-12 col-sm-12">
...
<?php
				if($this->session->userdata('data')=='hari' and $typegraf=='column')
				{
				?>
				<div class="row row-cards">
					...
					$akum = number_format($data_sensor->{'akumulasi_hujan'},1,'.','');

					if($akum <= 0) {
						echo '<span class="form-control w-100 rounded text-white" style="background-image: url(../pin_marker/kotak-hijau.png);background-repeat:no-repeat;background-position: center center;">';
					}
					elseif($akum >= 0.1 && $akum < 5) {

						echo '<span class="form-control w-100 rounded text-white" style="background-image: url(../pin_marker/kotak-cyan.png);background-repeat:no-repeat;background-position: center center;">';
					}
					elseif($akum >=  5 && $akum <  20){
						echo '<span class="form-control w-100 rounded text-white" style="background-image: url(../pin_marker/kotak-nila.png);background-repeat:no-repeat;background-position: center center;">';
					}
					elseif($akum >= 20 && $akum <  50) {
						echo '<span class="form-control w-100 rounded" style="background-image: url(../pin_marker/kotak-kuning.png);background-repeat:no-repeat;background-position: center center;">';
					}
					elseif($akum >=  50 && $akum <  100) {
						echo '<span class="form-control w-100 rounded text-white" style="background-image: url(../pin_marker/kotak-oranye.png);background-repeat:no-repeat;background-position: center center;">';
					}
					elseif($akum >=  100) {
						echo '<span class="form-control w-100 rounded text-white" style="background-image: url(../pin_marker/kotak-merah.png);background-repeat:no-repeat;background-position: center center;">';
					}
										?>
									...
									<div class="col">
										<div class="font-weight-medium">
											<div class="subheader">Akumulasi Curah Hujan tanggal <?php echo $this->session->userdata('pada') ?></div>
										</div>
										<div class="h1 mb-0 me-2 mt-0"><?php echo number_format($data_sensor->{'akumulasi_hujan'},1,'.','') ?> mm</div>
									</div>
								</div>
							</div>
						</div>
				...
				<?php } else if($this->session->userdata('data')=='bulan' or $this->session->userdata('data')=='range') { ?>
				<div class="row row-cards">
					...
					$hours = (strtotime($this->session->userdata('sampai')) - strtotime($this->session->userdata('dari'))) / 86400;
					$akum = number_format($data_sensor->{'akumulasi_hujan'}/$hours,1,'.','');
					if($akum <= 0) {
						echo '<span class="form-control w-100 rounded text-white" style="background-image: url(../pin_marker/kotak-hijau.png);background-repeat:no-repeat;background-position: center center;">';
					}
					elseif($akum >= 0.1 && $akum < 5) {
					...
					elseif($akum >=  100) {
						echo '<span class="form-control w-100 rounded text-white" style="background-image: url(../pin_marker/kotak-merah.png);background-repeat:no-repeat;background-position: center center;">';
									...
									<div class="col">
										<div class="font-weight-medium">
											<div class="subheader">Akumulasi Curah Hujan <br> <?= $this->session->userdata('dari') ?> - <?= $this->session->userdata('sampai') ?></div>
										</div>
										<div class="h1 mb-0 me-2 mt-0"><?php echo number_format($data_sensor->{'akumulasi_hujan'},1,'.','') ?> mm</div>
									</div>
								</div>
					...
					<div class="col-sm-12 <?= $this->session->userdata('data')=='range' ? 'col-lg-9': 'col-lg-12'?> mb-3">
						<div class="card card-sm h-100 ">
							<div class="card-body d-flex align-items-center">
								<div class="row w-100">
									<div class="col-auto d-flex align-items-center justify-content-xl-between">
								...
								<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
									...
									<div class="offcanvas-body">
										<div>
											...
											<img src="https://bbws.beacontelemetry.com/image/foto_pos/<?= $vl['url_foto']?>" class="img-fluid mb-2"/>
											<?php } ?>
											<?php } ?>
										</div>
									</div>
