...
<?php
$qstatus=$this->db->query('select waktu from temp_afmr where code_logger="'.$this->session->userdata('idlogger').'" order by waktu desc limit 1');
if($qstatus->result()){
...
') ?>
			...
			<div class="col col-md-auto">
				<h2 class="page-title">
					<?php echo $this->session->userdata('namalokasi'); ?>tes
			...
			<div class="col-12 col-md">
				...
				<div class="row g-2 align-items-center justify-content-end">
					...
					<div class="col-8 col-md-auto d-flex">
						<?php if($this->session->userdata('idlogger') == '10249'){ ?>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									...
									<?php  
	echo form_open('afmr/set_parameter');?>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									...
									<?php echo form_open('afmr/settgl') ;?>
									<div class="row">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<?php echo form_open('afmr/sesi_data');?>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('afmr/setbulan') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="input-icon">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('afmr/settahun') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="input-icon">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('afmr/setrange') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="row">
												<div class="col-12 col-md-12 col-sm-12">
	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body p-3 text-center d-flex justify-content-center">
				<img src="<?= base_url() ?>image/afmr.jpg" class="img-fluid w-100" />
			</div>
		</div>
	</div>
</div>
