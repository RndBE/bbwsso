					...
					<div class="nav-item dropdown">
						<div class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
							...
							<?php if ($this->session->userdata('leveluser') == 'admin' or $this->session->userdata('leveluser') == 'admin_bidang') { ?>
								<img src="<?= base_url() ?>image/logopu 4.png " width="110" height="32" alt="BBWS SO"
...
-->
						<div class="col-12 ">
							<ul class="list-inline mb-0">
								...
								<li class="list-inline-item">
									<img src="<?php echo base_url() ?>image/logo_be.png" alt="Beacon Engineering"
										class="navbar-brand-image">
								</li>
								<li class="list-inline-item">
									<img src="<?php echo base_url() ?>image/logostesy.png" alt="Beacon Engineering"
										class="navbar-brand-image">
								</li>
							</ul>
						</div>
	...
	<?php $this->load->view('template_admin/copilot'); ?>
</body>
