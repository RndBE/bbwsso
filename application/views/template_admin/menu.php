				...
				<?php if ($this->session->userdata('username') != 'serayu_opak') { ?>
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu">
							...
							<?php echo anchor('https://apps.apple.com/id/app/bbws-so/id6480156441', 'IOS App', 'class="dropdown-item ss" target="_blank"'); ?>
							<?php echo anchor('unduh/manualbook_awlr.pdf', 'Manual Book AWLR', 'class="dropdown-item"'); ?>

						</div>
					</li>
				<?php } ?>
				<?php if ($this->session->userdata('username') != 'serayu_opak') { ?>
					<li class="nav-item <?php if ($this->uri->segment(1) == 'pengaturan') {
						echo 'active';
					} ?>">
